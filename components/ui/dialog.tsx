...
const DialogHeader = ({
  ...
  <div
    className={cn("min-w-0 flex flex-col gap-1.5 text-center sm:text-left", className)}
    {...props}
  />
);
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "min-w-0 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end",
      className,
    )}
    {...props}
  />
